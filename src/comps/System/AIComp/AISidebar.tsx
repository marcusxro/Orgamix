...
const AISidebar: React.FC<AISidebarProps> = ({location}) => {
    ...
    return (
        <div className='w-full max-w-[200px] h-full border-r-[1px] border-r-[#535353] p-4 overflow-auto'>
                        ...
                        fetchedData?.map((chat, index) => {
                            return (
                                <div
                                    ...
                                    key={index} className={`${ location === chat?.created_at ? "bg-[#191919]" : "bg-[#232323] "} flex gap-4 items-center p-2 px-4 cursor-pointer border-[1px] hover:bg-[#212121] border-[#535353] rounded-lg text-sm`}>
